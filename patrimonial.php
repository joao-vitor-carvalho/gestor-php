...
<body>
  ...
  <div class="topbar transition">
	...
	$query = 'SELECT * FROM patrimonial ORDER BY name';
					...
					<div class="card">
						...
						<p>Pensar em recursos que podem ser listados, adicionados, editados ou deletados nessa página. 
							<?php 
								...
								echo '<div class="col-2"><b>Info</b></div>';
								echo '<div class="col-2"><b>Tipo</b></div>';
								echo '<div class="col-2"><b>Value</b></div>';
								echo '<div class="col-2"><b>Data</b></div>';
											...
											<div id="myModal1" class="modal" style="padding-top:100px;width: 100%; position:fixed; text-align: center ;background-color: rgba(0,0,0,0.4); ">
												...
												<!-- Modal content -->
													...
													<div class="container" style="width:250px; height:400px; background-color: white">
														<form id="myForm" action="adicionar_patrimonial.php" method="get">
															Nome: <input type="text" name="name"><br>
															Tipo: <input type="text" name="type"><br><br>
															Data: <input type="date" name="date"><br>
															Valor: <input type="text" name="value"><br>
															Info: <input type="text" name="info"><br>
															Geral Id: <input type="text" name="general_id"><br>
															<br>
								...
								foreach ($resultado as $item){
									...
									echo '<div class="col-2" >' .$item['info']. '</div>'; 
									echo '<div class="col-2" >' .$item['type']. '</div>'; 
									echo '<div class="col-2" >' .$item['value']. '</div>';
									echo '<div class="col-2" >' .$item['date']. '</div>';
	...
	<script>
		...
		var id = x;
		var url = "deletar_patrimonial.php?id=" + id;
