  ...
  <div class="topbar transition">
	...
	<div class="content-start transition  "> 
		<div class="container-fluid dashboard">
            ...
            <div class="row">
				<!-- cards personalizáveis com informações de relevância solicitadas pelo usuário -->
					...
					<div class="card">
						...
						<div class="card-body pb-4">
							<div class="recent-message d-flex px-4 py-3">
								...
								<div class="name ms-4">
									<h5 class="mb-1">João Pedro Pupe</h5>
									<h6 class="text-muted mb-0">@jpstats</h6>
								</div>
								</a>
							</div>
							<div class="recent-message d-flex px-4 py-3">
								...
								<a href="https://wa.me/556192525843" title="Fale diretamente com João Vitor">
								<div class="name ms-4">
									<h5 class="mb-1">João Vitor Barros</h5>
									<h6 class="text-muted mb-0">@jpstats</h6>
								</div>
								</a>
							</div>
							<div class="px-4">
								...
								<button class='btn btn-block btn-xl btn-primary font-bold mt-3'>Inicie ou Continue uma Conversa por Whatsapp</button>
								</a>
							</div>
						</div>
					</div>
